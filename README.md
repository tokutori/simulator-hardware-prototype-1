...
- ラック: 両面歯、全歯幅20 mm、中央ギャップなし、24歯で歯部約156 mm、押し面込み全長約166.8 mm
...
ラックの正X側先端には、物体を押すための30 × 20 mmのフラット面を持つ長さ8 mmの一体パッドを設けます。組立時の垂直方向Zはラック歯幅20 mmから広げず、横倒し印刷時のbuild plate面内Y方向だけを30 mmへ広げるため、追加の上下overhangはありません。
